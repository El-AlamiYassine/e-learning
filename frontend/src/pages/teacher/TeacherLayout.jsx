    ...
    <div className="d-flex" style={{ backgroundColor: 'var(--bg-main)', minHeight: '100vh' }}>
      ...
      <aside className="position-sticky top-0 d-none d-md-flex flex-column py-4 px-3 shadow-sm" style={{ width: '280px', height: '100vh', background: 'var(--bg-card)', borderRight: '1px solid var(--border-light)' }}>
        <div className="d-flex align-items-center mb-5 px-2">
          <div className="d-flex align-items-center justify-content-center text-white me-3" style={{ width: '40px', height: '40px', borderRadius: '12px', background: 'linear-gradient(135deg, #0f172a, #334155)', boxShadow: '0 4px 10px rgba(0,0,0,0.1)' }}>
            <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 14l9-5-9-5-9 5 9 5z" />
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z" />
            </svg>
          </div>
          <h4 className="m-0 fw-bold fs-5 text-dark letter-spacing-tight">Teacher Portal</h4>
        </div>

        <nav className="flex-grow-1 d-flex flex-column gap-1">
          <NavLink to="/teacher/dashboard" end className={getLinkClasses}>
          ...
          <NavLink to="/teacher/courses" className={getLinkClasses}>
          ...
          <NavLink to="/teacher/students" className={getLinkClasses}>
          ...
          <NavLink to="/teacher/analytics" className={getLinkClasses}>
          ...
          <NavLink to="/teacher/profile" className={getLinkClasses}>
            <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>
            Profil
          </NavLink>
        </nav>
        ...
        <div className="mt-auto border-top pt-4">
          <div className="d-flex align-items-center p-2 mb-3">
            <div className="text-white d-flex align-items-center justify-content-center fw-bold me-3 shadow-sm" style={{ width: '45px', height: '45px', borderRadius: '12px', background: 'linear-gradient(135deg, #0f172a, #334155)' }}>
      ...
      <main className="flex-grow-1 min-vh-100 d-flex flex-column overflow-hidden">
        ...
        <header className="d-md-none bg-white p-3 border-bottom d-flex align-items-center justify-content-between shadow-sm position-sticky top-0 z-3">
           <h4 className="m-0 fw-bold fs-5 text-dark">Teacher Portal</h4>
